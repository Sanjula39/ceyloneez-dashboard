...
function SectionTwo({ payload }) {
  ...
  const modifiedHTML = sanitizedHTML
    .replace(/href="/g, 'target="_blank" href="https://stepbysteptrade.lk')
    .replace(/View\n/g, "\n");
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ width: "50%" }}>
          <h1
            style={{ color: "#42C686", fontFamily: "Inter", fontWeight: "700" }}
          >
            2. The Stage of Your Certificate process
          </h1>

          <h3
            style={{ color: "#000000", fontFamily: "Inter", fontWeight: "700" }}
          >
          ...
          <div>
            ...
            >
              Upload Your business registration here
            </p>
          </div>
        </div>
        <div style={{ width: "50%" }}>
